  ...
  const faqs = [
    {
      ...
      answer: 'Avocet waste to wealth platform is an online marketplace or platform that aims to facilitate the conversion of waste materials into valuable resources. It connects waste generators with waste processors, recyclers, and other entities involved in the waste management and recycling industry. The platform promotes sustainability by encouraging the recycling and repurposing of waste materials, ultimately reducing their impact on the environment.'
    },
    {
      id: 2,
