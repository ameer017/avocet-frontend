...
const AppInner = () => {
  ...
  return (
    <section className="container inner">
      <div>
        <img
          src="https://images.pexels.com/photos/6083648/pexels-photo-6083648.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          loading="lazy"
        />
      </div>
      ...
      <div className="inner-right">
        ...
        <ShowOnLogout>
          ...
          >
            ...
            <li>
              Ensure that the waste is properly sorted, <br /> weighed, and
              packaged for further processing.
            </li>
            <li>
              Address must contain - House number, Street Name, <br />
              Nearest Landmark, State of Residence.{" "}
            </li>
          </ul>
        </ShowOnLogout>
        <button className="--btn --btn-success" onClick={registerCollector}>
          Click here
        </button>
