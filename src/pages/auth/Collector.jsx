        ...
        <Card>
            <div className='form'>
                    ...
                    <form onSubmit={registerUser}>
                        ...
                        <input type='text' placeholder='phn-number' required name='phone' value={phone} onChange={handleInputChange}/>

                        <input type='text' required name='role' value={role} onChange={handleInputChange} disabled/>
                        ...
                        <button className='--btn --btn-success --btn-block' type='submit'>{isLoading && <Loading/>}Register</button>
